...
const pageLoadedHandler = () => {
  document.getElementById('loading').style.display = "none";
   ...
   Enabler.setProfileId(10509293);
    ...
    if (centreName.length > 15 && centreName.length < 18) {
      centreNameDiv.style.fontSize = '13px';
      centreNameDiv.style.lineHeight = '15px';
    }
    if (centreName.length > 18) {
      centreNameDiv.style.fontSize = '11px';
      centreNameDiv.style.lineHeight = '13px';
    } 
